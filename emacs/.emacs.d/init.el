...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nix-mode nixos-options rainbow-mode yaml-mode unicode-fonts ace-window erc-hl-nicks erc-colorize doom-themes erc-image auctex auctex-lua counsel ivy magit guru-mode pdf-tools company company-ghc company-ghci haskell-mode flycheck hindent hlint-refactor zenburn-theme sr-speedbar)))
