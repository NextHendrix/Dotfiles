...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (doom-themes erc-image auctex auctex-lua counsel ivy magit guru-mode pdf-tools company company-ghc company-ghci haskell-mode flycheck hindent hlint-refactor zenburn-theme sr-speedbar)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Input Mono Narrow" :foundry "FBI " :slant normal :weight light :height 116 :width condensed)))))
